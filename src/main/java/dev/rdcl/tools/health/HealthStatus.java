...
public class HealthStatus {
    ...
    /**
     * @param healthyThreshold   The number of consecutive successes needed for the service to be considered to be
     *                           healthy.
     * @param unhealthyThreshold The number of consecutive failures needed for the service to be considered to be
     *                           unhealthy.
     */
